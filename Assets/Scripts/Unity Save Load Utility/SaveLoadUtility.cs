...
public class SaveLoadUtility : MonoBehaviour {
	...
	protected Dictionary<RefReconnecter,string> refDict;//used to reconnect fields of Type GameObject and those inheriting from Component to their respective reference instances again after loading.
	[HideInInspector]protected List<string> surrogateTypes = new List<string>() {
		"Vector2",
		"Vector3",
		"Vector4",
		"Quaternion",
	...
	public virtual void LoadGame(string saveGameName) {
	...
	protected void SetValues(ref object baseInstance, Dictionary<string,object> baseDict) {
